namespace BioSeqDB
{
  partial class BioSeqArtemis
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.label4.Text = "Run Artemis to visualize the genomic data in the selected input file. This may re" +
    "quire downloading / installing Artemis as well as the Java runtime. If possible," +
    " BioSeqDB will do this automatically.";
      // 
      // btnOK
      // 
      ...
      this.Name = "BioSeqArtemis";
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
      this.Text = "BioSeqDB Artemis Analysis";
      this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.BioSeqArtemis_FormClosing);
