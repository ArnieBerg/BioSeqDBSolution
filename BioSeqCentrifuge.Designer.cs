namespace BioSeqDB
{
  partial class BioSeqCentrifuge
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.txtMaxAssignments = new System.Windows.Forms.TextBox();
      ...
      this.label4.Text = "Create a taxonomic classification for a set of sequence reads using Centrifuge.";
      // 
      // btnOK
      // 
      ...
      this.btnCentrifugePath.Location = new System.Drawing.Point(586, 162);
      ...
      this.txtCentrifugePath.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
      this.txtCentrifugePath.Location = new System.Drawing.Point(12, 164);
      ...
      this.lblCentrifugeDBName.Location = new System.Drawing.Point(28, 187);
      ...
      // txtMaxAssignments
      // 
      this.txtMaxAssignments.Location = new System.Drawing.Point(334, 278);
      this.txtMaxAssignments.Name = "txtMaxAssignments";
      this.txtMaxAssignments.Size = new System.Drawing.Size(45, 20);
      this.txtMaxAssignments.TabIndex = 9;
      this.txtMaxAssignments.Text = "50";
      this.txtMaxAssignments.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
      this.txtMaxAssignments.TextChanged += new System.EventHandler(this.txtMaxAssignments_TextChanged);
      this.txtMaxAssignments.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtMaxAssignments_KeyPress);
      // 
      // label7
      // 
      ...
      this.label7.Text = "Maximum primary assignments for each read:";
      // 
      // btnFindInputPath
      // 
      ...
      this.btnFindInputPath.TabIndex = 72;
      ...
      this.Controls.Add(this.txtMaxAssignments);
      ...
      this.Name = "BioSeqCentrifuge";
      this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
      this.Text = "BioSeqDB Centrifuge Analysis";
      this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.BioSeqCentrifuge_FormClosing);
    ...
    private System.Windows.Forms.TextBox txtMaxAssignments;
